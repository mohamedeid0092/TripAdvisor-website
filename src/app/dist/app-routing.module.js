...
var routes = [
    ...
    { path: 'home', component: home_listing_component_1.HomeListingComponent },
    { path: 'hotels', component: hotels_listing_component_1.HotelsListingComponent },
    { path: 'cruises', component: cruises_component_1.CruisesComponent },
    { path: 'resturants', component: restaurant_listing_component_1.RestaurantListingComponent },
    { path: 'shopping', component: shopping_page_component_1.ShoppingPageComponent },
    { path: 'signup', component: singup_component_1.SingupComponent },
    { path: 'profile', component: profile_component_1.ProfileComponent },
    { path: 'mediaCenter', component: media_center_component_1.MediaCenterComponent },
    { path: 'helpCenter', component: help_center_component_1.HelpCenterComponent },
];
